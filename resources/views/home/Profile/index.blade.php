...
<div class="row d-flex justify-content-around">
    ...
    <div class="card p-4 col-md-8">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">First Name = <strong>
        ...
        <div class="d-flex justify-content-end mt-5">
            @if (empty(Auth::user()->profile->image))
                <a href="{{ route('profile.create-profile') }}" class="btn btn-info me-2">Create Profile <i class="bi bi-plus-lg"></i></a>
            @else
                <a href="{{ route('profile.edit-profile') }}" class="btn btn-info me-2">Edit Profile <i class="bi bi-pencil-square"></i></a>
            @endif
